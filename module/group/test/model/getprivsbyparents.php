...
r($groupTest->getPrivsByParentsTest('my', '')) && p('my-index') && e('工作台仪表盘'); // 步骤1：获取 my 子集的权限
...
r($groupTest->getPrivsByParentsTest('my', '|my|')) && p('my-index') && e('工作台仪表盘'); // 步骤4：获取 my 子集指定包的权限
