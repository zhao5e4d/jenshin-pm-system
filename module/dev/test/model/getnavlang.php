...
检查传入空值时的情况 >> <i class='icon icon-menu-my'></i> 工作台|my|index|
...
r($devTester->getNavLangTest($typeList[0], $moduleList[0], $methodList[0], $languageList[0])) && p('my')              && e("<i class='icon icon-menu-my'></i> 工作台|my|index|");         // 检查传入空值时的情况
...
r($devTester->getNavLangTest($typeList[3], $moduleList[0], $methodList[0], $languageList[0])) && p('my')              && e("<i class='icon icon-menu-my'></i> 工作台|my|index|");         // 检查获取三级导航
...
r($devTester->getNavLangTest($typeList[4], $moduleList[0], $methodList[0], $languageList[0])) && p('my')              && e("<i class='icon icon-menu-my'></i> 工作台|my|index|");         // 检查传入不存在的type
